...
export class UIKRenderer {
  ...
  public drawRotatedText(cfg: textPrim.RotatedTextConfig): void { textPrim.drawRotatedText(this._gl, cfg) }
  public drawTextOffset(cfg: textPrim.TextOffsetConfig): void   { textPrim.drawTextOffset(this._gl, cfg) }
  public drawText(cfg: textPrim.RotatedTextConfig): void        { textPrim.drawText(this._gl, cfg) }
  public drawTextCenteredOn(cfg: textPrim.TextOffsetConfig): void { textPrim.drawTextCenteredOn(this._gl, cfg) }
  public drawBox(cfg: boxPrim.BoxConfig): void                  { boxPrim.drawBox(this._gl, cfg) }

  // --- Composites ---
  public drawTextBox(cfg: tbox.TextBoxConfig): void              { tbox.drawTextBox(this._gl, cfg) }
  ...
  // --- UI Components ---
  public drawToggle(cfg: tog.ToggleConfig): void                { tog.drawToggle(cfg) }
  public drawSlider(cfg: sld.SliderConfig): void                { sld.drawSlider(cfg) }
